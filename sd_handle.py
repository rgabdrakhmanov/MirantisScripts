...
# Prerquisites: files sd_nodes3os.py and sd_patterns_search.sh exist in same folder as sd_handle.py, and sd_patterns_search.sh is executable
...
HOME = os.path.expanduser("~")        #HOME = Path.home()    # same result as the os.path.expanduser("~") 
...
os.rename(os.path.join(SD_DOWNLOAD_DIR, downloaded_sd_files[0]), fullpath_sd_zip_no_spaces) # do the actual rename here
